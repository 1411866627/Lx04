...
namespace Model
{
    ...
    public class Activity
    {
        ...
        public DateTime recommendTime { get; set; }  //其他属性名称、类型对应数据库Activity表的字段名称、类型（可查看work.txt的建表语句获取），请自行补充
    ...
    public class WorkInfo
    {
        ...
        public string recommend { get; set; }
        public DateTime recommendTime { get; set; }  //其他属性名称、类型对应数据库WorkInfo表的字段名称、类型，请自行补充
    }
    public class Comment
    {
        ...
        public DateTime commentTime { get; set; } //其他属性名称、类型对应数据库Comment表的字段名称、类型，请自行补充
    }
